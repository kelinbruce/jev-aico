#!/usr/bin/env python3
"""Jev Choice demo: choose one option from a predefined set."""
...
def request_choice(state: str) -> dict:
    payload = {
        "model": "jev-latest",
        "state": state,
        "questions": {
            "department": {
                ...
                "criteria": {
                    ...
                    "technical": "Software, account access, or system failures",
                    "sales": "Pricing, purchasing, or product information",
                },
            }
        },
    }
